...
<head>
    ...
    <link rel="icon" href="{{url('/static/daohang/')}}/icon/280.png?v=1.0.1" sizes="280x280"/>
    <link rel="apple-touch-icon-precomposed" href="{{url('/static/daohang/')}}/icon/280.png?v=1.0.1"/>
    <meta name="msapplication-TileImage" content="{{url('/static/daohang/')}}/icon/280.png?v=1.0.1"/>
    ...
    <title>DYCMS-内容导航第一站</title>
    <link href="{{url('/static/daohang/')}}/style.css?t=<?php echo date("ymdhi"); ?>" rel="stylesheet">
    <link href="{{url('/static/daohang/')}}/wea.css?t=<?php echo date("ymdhi"); ?>" rel="stylesheet">
    ...
    <script src="{{url('/static/daohang/')}}/sou.js?t=<?php echo date("ymdhi"); ?>"></script>
    <script src="{{url('/static/daohang/')}}/wea.js?t=<?php echo date("ymdhi"); ?>"></script>
</head>
...
<div class="list closed">
    <ul>
        ...
        <li><a rel="nofollow" href="https://www.bilibili.com/" target="_blank">
                ...
                哔哩哔哩</a></li>
        <li><a rel="nofollow" href="https://www.nfmovies.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-netflix"></use>
                </svg>
                奈非影视</a></li>
        <li><a rel="nofollow" href="https://k1080.net/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-yingshi"></use>
                </svg>
                K1080</a></li>
        <li><a rel="nofollow" href="https://www.yunbtv.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://mail.google.com/mail/u/0/#inbox" target="_blank">
                ...
                Gmail</a></li>
        <li><a rel="nofollow" href="https://outlook.live.com/mail/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-windows"></use>
                </svg>
                Hotmail</a></li>
        <li><a rel="nofollow" href="https://mail.163.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-wangyi"></use>
                </svg>
                网易邮箱</a></li>
        <li><a rel="nofollow" href="https://mail.sina.com.cn/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://www.zhihu.com/" target="_blank">
                ...
                知乎</a></li>
        <li><a rel="nofollow" href="https://www.douban.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-douban"></use>
                </svg>
                豆瓣</a></li>
        <li><a rel="nofollow" href="https://www.jianshu.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://www.twitter.com" target="_blank">
                ...
                Twitter</a></li>
        <li><a rel="nofollow" href="https://www.facebook.com" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://www.taobao.com" target="_blank">
                ...
                淘宝网</a></li>
        <li><a rel="nofollow" href="https://dyartstyle.com/juhuasuan/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-juhuasuan"></use>
                </svg>
                聚划算</a></li>
        <li><a rel="nofollow" href="https://dyartstyle.com/temai/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow"
               ...
               title="拼多多手机端专属商城，超低价商品火热抢购中，更有超多大额优惠券持续发放，一键立抢>>" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://www.jd.com" target="_blank">
                ...
                京东</a></li>
        <li><a rel="nofollow" href="https://www.suning.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-suning"></use>
                </svg>
                苏宁易购</a></li>
        <li><a rel="nofollow" href="http://you.163.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="http://www.dangdang.com/" target="_blank">
                ...
                当当</a></li>
        <li><a rel="nofollow" href="https://wat.dyartstyle.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://hao.5iux.cn/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-daohang1"></use>
                </svg>
                设计导航</a></li>
        <li><a rel="nofollow" href="https://www.pinterest.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-pinterest"></use>
                </svg>
                Pinterest</a></li>
        <li><a rel="nofollow" href="https://www.behance.net/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-behance"></use>
                </svg>
                Behance</a></li>
        <li><a rel="nofollow" href="https://www.dribbble.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-dribbble"></use>
                </svg>
                Dribbble</a></li>
        <li><a rel="nofollow" href="https://huaban.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-huaban"></use>
                </svg>
                花瓣</a></li>
        <li><a rel="nofollow" href="https://www.zcool.com.cn/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-zhanku"></use>
                </svg>
                站酷</a></li>
        <li><a rel="nofollow" href="https://www.iconfont.cn/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-iconfont"></use>
                </svg>
                阿里图标</a></li>
        <li><a rel="nofollow" href="https://www.iconfinder.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-eye"></use>
                </svg>
                IconFinder</a></li>
        <li><a rel="nofollow" href="https://uiiiuiii.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://www.sogou.com/" target="_blank">
                ...
                搜狗</a></li>
        <li><a rel="nofollow" href="https://www.naver.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-icon-test"></use>
                </svg>
                NAVER</a></li>
        <li><a rel="nofollow" href="https://mijisou.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://www.dogedoge.com/" target="_blank">
                ...
                多吉</a></li>
        <li><a rel="nofollow" href="https://seeres.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-sousuo"></use>
                </svg>
                seeres</a></li>
        ...
        <li><a rel="nofollow" href="https://tools.miku.ac/" target="_blank">
                ...
                Miku工具</a></li>
        <li><a rel="nofollow" href="/ip/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://translate.google.cn/?hl=zh-CN" target="_blank">
                ...
                谷歌翻译</a></li>
        <li><a rel="nofollow" href="http://www.slimego.cn/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-shilaimu"></use>
                </svg>
                史莱姆</a></li>
        <li><a rel="nofollow" href="https://feedly.com" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-feedly"></use>
                </svg>
                Feedly</a></li>
        <li><a rel="nofollow" href="https://pan.baidu.com" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-baiduyun"></use>
                </svg>
                百度网盘</a></li>
        <li><a rel="nofollow" href="http://www.mdeditor.com/" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-md"></use>
                </svg>
                MD编辑器</a></li>
        <li><a rel="nofollow" href="http://cubic-bezier.com" target="_blank">
                <svg class="icon" aria-hidden="true">
                    <use xlink:href="#icon-quxian"></use>
                </svg>
                贝赛尔曲线</a></li>
        <li><a rel="nofollow" href="/base64/" target="_blank">
                <svg class="icon" aria-hidden="true">
        ...
        <li><a rel="nofollow" href="https://ping.chinaz.com/" target="_blank">
                ...
                站长Ping</a></li>
        <li><a rel="nofollow" href="https://apkdl.in/" target="_blank">
                <svg class="icon" aria-hidden="true">
...
<div class="mywth" style="width: 200px;">
    <iframe allowtransparency="true" frameborder="0" width="317" height="28" scrolling="no"
            src="//tianqi.2345.com/plugin/widget/index.htm?s=3&z=1&t=1&v=0&d=1&bd=0&k=&f=&ltf=009944&htf=cc0000&q=1&e=0&a=1&c=54511&w=317&h=28&align=center"></iframe>
</div>
<div id="content">
    <div class="con">
        <div class="shlogo"
             style="background: url({{url('/static/daohang/')}}/icon/logo.png) no-repeat center/cover;"></div>
        <div class="sou">
            <form action="//www.baidu.com/s" method="get" target="_blank">
				<?php
				if ($t == "g") {
					echo '<div class="lg" style="background: url(' . url('/static/daohang/') . '/icon/g.svg) no-repeat center/cover;" onclick="window.location.href=\'?t=b\';"></div>';
				} else {
					//上面知道把默认谷歌改成百度，这里不知道改吗大佬们？。。
					echo '<div class="lg" style="background: url(' . url('/static/daohang/') . '/icon/baidu.svg) no-repeat center/cover;" onclick="window.location.href=\'?t=\';"></div>';
    ...
    <div class="foot" style="height: 40px;">
        <a href="https://www.dongyao.ren" style="color: #777;">作者博客</a> |
        <a href="https://github.com/dongyao8/dycms" style="color: #777;">Github</a> |
        <a href="https://gitee.com/dongyao/dycms" style="color: #777;">Gitee</a> |<br>
        © 前端设计  <a href="https://blog.5iux.cn/">5iux</a> . 后端采用Dycms强力驱动.
    </div>
</div>
<!--
作者:D.Young
